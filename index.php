...
<body>
    ...
    <div class="container-fluid">
      <div class="navbar-header">
        <div class="navbar-icon-container">
          ...
          <a href="#" class="navbar-icon pull-left visible-xs" id="sidebar-toggle-btn"><i class="fa fa-chevron-right fa-lg white"></i></a>
        </div>
      ...
      <div class="navbar-collapse collapse">
        ...
        <ul class="nav navbar-nav">
          <li class="hidden-xs">
            <a href="#" data-toggle="collapse" data-target=".navbar-collapse.in" id="list-btn"><i class="fa fa-bars"></i>&nbsp;&nbsp;POI</a>
          </li>
          <li>
            <a href="#" data-toggle="collapse" data-target=".navbar-collapse.in" id="navigate-btn"><i class="fa fa-map-signs"></i>&nbsp;&nbsp;Navigate</a>
          </li>
          <li>
            <a href="#" data-toggle="collapse" data-target=".navbar-collapse.in" id="about-btn"><i class="fa fa-question"></i>&nbsp;&nbsp;About</a>
          </li>
          <li class="dropdown">
            <a id="toolsDrop" href="#" role="button" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-wrench"></i>&nbsp;&nbsp;Tools
              <b class="caret"></b></a>
            <ul class="dropdown-menu">
              ...
              <li>
                <a href="#" data-toggle="collapse" data-target=".navbar-collapse.in" id="events-btn"><i class="fa fa-calendar"></i>&nbsp;&nbsp;Show Events</a>
              </li>
              <li>
                <a href="#" data-toggle="collapse" data-target=".navbar-collapse.in" id="problem-btn"><i class="fa fa-bug"></i>&nbsp;&nbsp;Report a Problem</a>
              </li>
              <li>
        ...
        <div class="modal-body">
          ...
          <div class="tab-content" id="aboutTabsContent">
            <div class="tab-pane fade active in" id="about">
              <p style="margin: 20px;">
                PHINMA UPang is a fairly large campus with an estimated 12,000 students. New buildings are built to
                accommodate all of its student. This will result to relocation of some buildings and facilities. Thus, this
                confuse the students especially new-comers and visitors. This project was develop to help students, staff and
                ...
                <div class="col-md-12">
                  ...
                  <div class="color-left">
                    <p style="margin: 10px;">
                      ...
                      non-sectarian university located at Dagupan, Pangasinan, Philippines. It is a member
                      of the PHINMA Education Network (PEN). It offers practically all undergraduate and
                      graduate courses that Metro Manila universities offer. It has a staff of about 300
                    ...
                    <div id="content">
                      <ul class="timeline-1 text-black">
                        <li class="event" data-date="1925">
                          ...
                          <p>The University of Pangasinan started operation in 1925 as the Dagupan
                            Institute, which offered elementary, secondary and vocational courses.
                            It was founded by Dean Francisco Benitez, Dr. Blas F. Rayos, Dr. Apolinario
                            delos Santos, and Dr. Sylvestre Pascual. Rayos became the
                            president of the school and headed it for 45 years until 1975 when he died
                            and was succeeded by his son, George O. Rayos, who served as president until
                            1987. In 1937, the College of Liberal Arts was established with the president
                            Blas F. Rayos Sr. as its first dean.</p>
                        </li>
                        <li class="event" data-date="1941">
                          <h4 class="mb-3 pt-3">Dagupan Junior College</h4>
                          <p>In 1941, the school was renamed the Dagupan Junior College. Its operation was
                            interrupted by the outbreak of World War II in December 1941. It resumed
                            operation in 1945 immediately after the war. Four courses were added to its
                            offering soon after. These were Civil Engineering, Architecture, Graduate School,
                            and Secretarial Science. Shortly thereafter, additional courses were offered such
                            as Secondary Education, Law, Home Economics, Nursing, and Commerce, with major in
                        ...
                        <li class="event" data-date="1950">
                          ...
                          <p>In 1950, the school assumed the name Dagupan Colleges, and the Graduate School
                            added courses leading to the degrees of Master of Arts in Philosophy and Master of
                            Science in Business Administration. The school started a review class in Nursing
                            in 1954. Eventually, review classes in Accounting, Civil Engineering and Law were
                            offered. The year 1959 saw further expansion of curricular offerings with the
                            opening of courses leading to the degrees of Bachelor of Science in Foods and
                            Nutrition, and Bachelor of Science in Journalism.
                            In the next decade following were added: the organization of Naval Reserve
                            Officers' Training Corps (NROTC) and the Naval Women's Auxiliary Corps in 1960,
                            and the offering of the Sanitary Engineering course in 1965.</p>
                        </li>
                        <li class="event" data-date="1968">
                          <h4 class="mb-3 pt-3">Status</h4>
                          <p class="mb-0">On July 3, 1968, the college was converted into a university by
                            virtue of the University Charter granted by the Department of Education.
          ...
          <form action="php/create.php" method="POST">
            ...
            <div class="form-group">
              ...
              <input class="form-control" value="<?php if (isset($_GET['problemTitle']))
                                                    echo ($_GET['problemTitle']); ?>" id="inputEventName" type="text" name="problemTitle" placeholder="Title" required />
            </div>
            <div class="form-group">
              <label for="problemType">Category</label>
              <select class="form-control" value="<?php if (isset($_GET['problemType']))
                                                    echo ($_GET['problemType']); ?>" id="exampleSelect1" name="problemType" required>
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" value="<?php if (isset($_GET['problemDesc']))
                                                      echo ($_GET['problemDesc']); ?>" name="problemDesc" placeholder="Write a short description of your report..." rows="10" cols="100" required></textarea>
            </div>
            <div class="form-group">
              <input class="form-control" id="problemStatus" value="Pending" name="problemStatus" type="hidden" placeholder="Status" />
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-danger" data-dismiss="modal" onclick="clearReportTextArea();">
                Cancel
              </button>
          ...
          <form action="php/create.php" method="POST">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" value="<?php if (isset($_GET['feedbackText']))
                                                      echo ($_GET['feedbackText']); ?>" name="feedbackText" placeholder="Write your feedback here..." rows="5" cols="10" style="resize: vertical;" required></textarea>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-danger" data-dismiss="modal" onclick="clearReportTextArea();">
                Cancel
  ...
  <div class="modal fade" id="descriptionModal" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
        ...
        <div class="modal-body">
          ...
          <p id="description-poi-2"></p>
          <p id="description-poi-3"></p>
          <p id="description-poi-4"></p>
          <p id="description-poi-5"></p>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-success" data-dismiss="modal">
            Close
